    ...
    <KeyboardAvoidingView
      ...
      <ScrollView className="flex-1 bg-gradient-to-br from-orange-400 via-red-500 to-pink-500">
        <Animated.View
          ...
          {/* Login Form */}
          <View className="rounded-3xl bg-white/95 p-8 shadow-2xl backdrop-blur-sm">
            ...
            <View className="mb-6">
              ...
              <View className="flex-row items-center rounded-2xl border border-gray-200 bg-gray-50 px-4 py-4">
            ...
            <TouchableOpacity
              onPress={handleLogin}
              disabled={isLoading}
              className={`rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 py-4 shadow-lg ${
            ...
            <View className="space-y-3">
              <TouchableOpacity className="flex-row items-center justify-center rounded-2xl bg-blue-600 py-4">
